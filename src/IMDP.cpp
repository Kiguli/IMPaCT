...
/* =============================================================================
 * COST FUNCTIONS FOR NORMAL DISTRIBUTIONS
 * =============================================================================
 * Phase 2 Refactoring: Replaced 473 lines (lines 107-579) of duplicated cost
 * function structs and implementations with templated versions in cost_functions.h
 *
 * Original implementation had 12 variants:
 *   - 3 parameter counts (1, 2, 3)
 *   - 2 noise types (diagonal, off-diagonal)
 *   - 2 space variants (regular, Full)
 *
 * Now consolidated using template metaprogramming with policy-based design.
 * All functions maintain identical behavior and numerical results.
 * ============================================================================= */
