...
|----|-------|--------|----------|--------|
| [0001](0001-sorted-synthesis-tolerance-stopping.md) | v1 sorted synthesis uses tolerance stopping, not sound interval iteration | resolved | medium | soundness, tool-v1 |
...
| [0006](0006-dense-transition-matrix-oom.md) | Dense transition matrix causes memory overflow even on "small" cases | resolved | high | scalability, memory |
...
| [0004](0004-ltlf-dfa-and-product.md) | Phase 2 — LTLf→DFA (done) + IMDP×DFA product + co-safe reachability | resolved | medium | enhancement, phase-2 |
...
| [0020](0020-sparse-vs-dense-abstraction-discrepancy.md) | Sparse (closed-form) and dense (nlopt) abstractions disagree on AS/BA | resolved | medium | correctness, abstraction, soundness |
| [0021](0021-nonlinear-mean-enclosure-not-certified.md) | Nonlinear mean enclosure (point-sampling / nlopt) is heuristic, not certified-sound | resolved | medium | soundness, abstraction, nonlinear, design-decision |
