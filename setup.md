...
The folder [misc](./misc) contains code in MATLAB, Python, R, etc. that can be used to read and open these HDF5 files for the purposes of plotting figures or using the controllers.
